...
{
	 formatAMPM();   //function in which date and time is calculated
}
...
var getLogs = function () {// search for the items of selected cowid from mongodb
    
    var ajax = $.ajax({
        url: "http://192.168.1.12:3009/search/"+vehicleName,
        type: "POST",
